...
export DEFAULT_FILE_MANAGER=~/.local/bin/filemanager
...
eval "$(oh-my-posh init zsh --config /home/vinicius/Documents/custom-spaceship.omp.json)"

# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

export PATH=$PATH:/home/vinicius/.spicetify
